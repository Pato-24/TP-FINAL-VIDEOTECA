...
export const getAlquileres = () => axios.get(API_URL);
...
export const editAlquiler = (id, data) => axios.put(`${API_URL}/${id}`, data);

// Elimina un alquiler por ID (DELETE)
export const deleteAlquiler = (id) => axios.delete(`${API_URL}/${id}`);